...
JAZZMIN_SETTINGS = {
    ...
    "user_avatar": lambda request: request.user.profile.sekil.url 
    if hasattr(request.user, "profile") and request.user.profile.sekil 
    else "/static/vendor/adminlte/img/user2-160x160.jpg",
