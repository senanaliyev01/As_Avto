...
class Mehsul(models.Model):
    ...
    istifadeci = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='mehsullar')
...
class Sifaris(models.Model):
    ...
    satici = models.ForeignKey(User, on_delete=models.CASCADE, related_name='gelen_sifarisler', null=True, blank=True)
