...
@login_required
def mehsul_haqqinda(request, mehsul_adi, mehsul_oem, mehsul_brend_kod):
    mehsul = get_object_or_404(Mehsul, oem=mehsul_oem, brend_kod=mehsul_brend_kod)
    return render(request, 'mehsul_haqqinda.html', {'mehsul': mehsul})
