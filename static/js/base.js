    ...
    document.addEventListener('DOMContentLoaded', () => {
        try {
            ...
            // Axtarış inputunda yazı yazıldıqda
                ...
                searchTimeout = setTimeout(() => {
                    ...
                    .then(data => {
                        if (data.results && data.results.length > 0) {
                            ...
                            data.results.forEach(result => {
                                ...
                                resultItem.innerHTML = `
                                    ...
                                    <div class="search-result-info">
                                        <h4>${result.adi}</h4>
                                        <p>Brend kod: ${result.brend_kod || 'N/A'}</p>
                                        <p>OEM: ${result.oem || 'N/A'}</p>
                                        <p>Qiymət: ${result.qiymet} ₼</p>
                                    </div>
                                `;
                            ...
                            resultsDropdown.innerHTML = '<div class="search-result-item">Heç bir nəticə tapılmadı</div>';
                            resultsDropdown.classList.add('active');
                        }
                    })
                    .catch(error => {
            ...
            searchBtn.addEventListener('click', function() {
                ...
                if (query) {
                    window.location.href = `/mehsullar/products/?search_text=${encodeURIComponent(query)}`;
                }
            });
            ...
            // Səhifənin başqa yerinə klikləndikdə dropdown-u bağla
